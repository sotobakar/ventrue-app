...
@section('content')
    <h1 class="text-2xl text-center font-semibold text-gray-900">List Menunggu Persetujuan</h1>
    <div class="mt-4 flex flex-col">
        <div class="mb-8">
            <h2 class="text-xl font-medium text-pink-600">Pencarian</h2>
            <form action="{{ route('biroakpk.approvals') }}" class="mt-2 flex gap-x-4">
                <div>
                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="relative py-3.5 pl-3 pr-4 sm:pr-6">
                                    <span class="sr-only">Setujuis</span>
                                </th>
                            </tr>
                        </thead>
                            ...
                            @foreach ($events as $event)
                                <tr x-data="{ showModal: false }">
                                    ...
                                    <td
                                        ...
                                        <a href="{{ route('biroakpk.approvals.detail', ['event' => $event->id]) }}"
                                                    ...
                                                    <div x-show="showModal" x-transition:enter="ease-out duration-300"
                                                        ...
                                                        <div class="sm:flex sm:items-start">
                                                            ...
                                                            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                                                <h3 class="text-base font-semibold leading-6 text-gray-900"
                                                                    id="modal-title">Setujui Acara</h3>
                                                                <div class="mt-2">
                                                        ...
                                                        <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                                            <form id="{{ 'approve-' . $event->id }}"
                                                                action="{{ route('biroakpk.approvals.approve', ['event' => $event->id]) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('POST')
                                                            </form>
                                                            <button @click="showModal= false"
                                                                form="{{ 'approve-' . $event->id }}" type="submit"
