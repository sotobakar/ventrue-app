@extends('biroakpk.layouts.guest')
...
<div class="bg-gray-900 flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
  ...
  <p class="text-pink-600 uppercase font-bold text-center text-lg">Biro AKPK</p>
  @if($errors->any())
  ...
  <div class="mt-4 sm:mx-auto sm:w-full sm:max-w-md">
    <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
      <form class="space-y-6" action="{{ route('biroakpk.login') }}" method="POST">
        @csrf
        <div>
