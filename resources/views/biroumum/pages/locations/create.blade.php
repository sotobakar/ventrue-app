...
@section('content')
    <h1 class="text-2xl font-semibold text-gray-900">Buat Lokasi</h1>
    <form action="{{ route('biroumum.locations') }}" method="POST"
        class="mt-8 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
        @csrf
