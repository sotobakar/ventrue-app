...
@section('content')
    ...
    <div class="mt-4 flex flex-col">
        <div class="mb-4">
            <form action="{{ route('admin.organizations') }}" class="flex gap-x-4">
                <div>
                    <label for="filter[name]" class="block text-sm leading-6 text-gray-900">Nama Ormawa</label>
                    <div class="mt-0.5">
                                                    ...
                                                    <div x-show="showModal" x-transition:enter="ease-out duration-300"
                                                        ...
                                                        <div class="sm:flex sm:items-start">
                                                            ...
                                                            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                                                <h3 class="text-base font-semibold leading-6 text-gray-900"
                                                                    id="modal-title">Hapus Ormawa</h3>
                                                                <div class="mt-2">
                                                                    <p class="whitespace-normal text-sm text-gray-500">
                                                                        Yakin untuk menghapus organisasi
                                                                        {{ $organization->name }}? Anda tidak bisa
                                                        ...
                                                        <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                                            ...
                                                            <button @click="showModal= false"
                                                                form="{{ 'delete-' . $organization->id }}" type="submit"
