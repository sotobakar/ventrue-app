...
@section('content')
    ...
    <div class="mt-4 flex flex-col">
        <div class="mb-4">
            <form action="{{ route('admin.students') }}" class="flex gap-x-4">
                <div>
                    <label for="filter[name]" class="block text-sm leading-6 text-gray-900">Nama Mahasiswa</label>
                    <div class="mt-0.5">
                ...
                <div>
                    <label for="filter[name]" class="block text-sm leading-6 text-gray-900">NIM</label>
                    <div class="mt-0.5">
                        <input type="text" name="filter[nim]" value="{{ request()->input('filter.nim') }}"
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-pink-600 sm:text-sm sm:leading-6"
                            placeholder="NIM">
                    </div>
                </div>
