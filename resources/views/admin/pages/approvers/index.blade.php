                            ...
                            @foreach ($approvers as $approver)
                                <tr>
                                    ...
                                    <td x-data="{ open: false }"
                                        ...
                                        <div x-show="open" x-cloak class="relative z-10" aria-labelledby="modal-title"
                                            ...
                                            <div class="fixed inset-0 z-10 overflow-y-auto">
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <div>
                                                            <h3 class="text-xl whitespace-normal mr-3">Edit  Penyetuju untuk Tingkatan {{ $approver->faculty->name ?? "Universitas"}}
                                                            </h3>
                                                            <form id="{{ 'update_approver_' . $approver->id }}"
                                                                ...
                                                                <div>
                                                                    <label for="name"
                                                                        class="block text-sm font-medium text-gray-700"> Nama Penyetuju</label>
                                                                    <div class="mt-1">
                                                                ...
                                                                <div class="mt-2">
                                                                    <label for="email"
                                                                        class="block text-sm font-medium text-gray-700">Email Penyetuju</label>
                                                                    <div class="mt-1">
