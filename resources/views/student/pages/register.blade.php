                ...
                <div class="mt-6">
                    <form action="{{ route('student.register') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="email" id="email" autocomplete="email" placeholder="Email" value="{{ old('email') }}" required
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500 sm:text-sm">
                        </div>

                        <div>
                            <label for="name" class="sr-only">Nama Lengkap</label>
                            <input type="text" name="name" id="name" autocomplete="name" placeholder="Nama Lengkap"
                                required
                                value="{{ old('name') }}"
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500 sm:text-sm">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="faculty_id" id="faculty_id" autocomplete="faculty_id"
                        ...
                        <div>
                            ...
                            <input type="number" name="year" min="1900" max="2099" step="1" placeholder="Tahun Angkatan" required
                            value="{{ old('year') }}"
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500 sm:text-sm">
                        </div>
