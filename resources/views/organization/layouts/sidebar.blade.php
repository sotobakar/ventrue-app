...
<div class="hidden md:fixed md:inset-y-0 md:flex md:w-64 md:flex-col">
    ...
    <div class="flex min-h-0 flex-1 flex-col bg-gray-800">
        <div class="flex flex-1 flex-col overflow-y-auto pt-5 pb-4">
            ...
            <nav class="mt-5 flex-1 space-y-1 px-2">
                ...
                <a href="#"
                    class="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                    <i
                        class="far fa-file-check fa-fw text-lg text-center align-middle text-gray-400 group-hover:text-gray-300 mr-3 flex-shrink-0"></i>
                    Proposal
                </a>
        ...
        <div class="flex flex-shrink-0 bg-gray-700 p-4">
            <a href="{{ route('organization.profile') }}" class="group block w-full flex-shrink-0">
                <div class="flex items-center">
                    <div>
                        <img class="inline-block h-9 w-9 rounded-full"
                            src="{{ Auth::user()->organization->image ? asset('storage/' . Auth::user()->organization->image) : asset('img/placeholder.png') }}"
                            alt="">
                    </div>
                    <div class="ml-3">
                        <p class="text-sm font-medium text-white">{{ Auth::user()->organization->name }}</p>
