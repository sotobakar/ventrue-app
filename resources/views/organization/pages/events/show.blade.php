            ...
            <div class="w-1/2">
                <div class="flex flex-col gap-y-2 px-4 sm:px-6">
                    ...
                    <div>
                        ...
                        <a href="{{ $event->meeting_link }}" target="_blank" class="mt-1 text-sm text-pink-500">{{
                            $event->meeting_link }}</a>
                        @else
        ...
        <div class="hidden sm:block">
            <div class="border-b border-gray-200">
                <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                    <a :class="tab === 'pendaftaran' ? 'border-pink-500 text-pink-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'"
                    ...
                    <a :class="tab === 'absensi' ? 'border-pink-500 text-pink-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'"
                    ...
                    <a :class="tab === 'materi' ? 'border-pink-500 text-pink-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'"
                        @click.prevent="tab = 'materi'; window.location.hash = 'materi'" href="#"
                        class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm"
                        aria-current="page">Materi</a>

                    <a :class="tab === 'sertifikat' ? 'border-pink-500 text-pink-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'"
                                ...
                                <thead class="bg-gray-50">
                                    <tr>
                                        <th scope="col"
                                            ...
                                            Nama Materi</th>
                                        <th scope="col"
                                            class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Download
                                            File</th>
                                ...
                                <tbody class="divide-y divide-gray-200 bg-white">
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <button form="{{ 'delete_material' . $material->id }}" type="submit"
                                ...
                                <div @click.outside="modal = false"
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-3 text-center sm:mt-5">
                                            ...
                                            <div class="mt-2">
                                                <p class="text-sm text-gray-500">File harus berupa .pdf atau .ppt dengan
                                                    ukuran maks 10MB.</p>
                                            </div>
                                        </div>
                                        <form class="mt-2"
