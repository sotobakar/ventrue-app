...
class Event extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['name', 'banner', 'location', 'meeting_link', 'type', 'registration_start', 'registration_end', 'start', 'end', 'description', 'organization_id', 'event_category_id', 'attendance_open'];
